  ...
  return dispatch => {
    ...
    dispatch(authGetToken())
      ...
      .then(parsedRes => {
        ...
        return fetch(
          "https://footiosplaces-1557725622585.firebaseio.com/places.json?auth=" + authToken,
          {
            method: "POST",
...
export const getPlaces = () => {
  return dispatch => {
    dispatch(authGetToken())
      .then(token => {
        return fetch(
          "https://footiosplaces-1557725622585.firebaseio.com/places.json?auth=" +
            token
        );
      })
      .catch(() => {
  ...
  return dispatch => {
    dispatch(authGetToken())
      ...
      .then(token => {
        ...
        return fetch(
          "https://footiosplaces-1557725622585.firebaseio.com/places/" +
            key +
            ".json?auth=" +
            token,
          {
